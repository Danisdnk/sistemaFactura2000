...
public class RepoFactory {
    ...
    private static Repository<OrdenCompra> OrdenCompraRepository;
    ...
    public static Repository<OrdenCompra> getRepoOrdenCompra(){  return new Repository<>(OrdenCompra.class); }
